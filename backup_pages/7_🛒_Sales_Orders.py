"""
Sales Orders Page - Manage customer sales orders
"""
import streamlit as st
from datetime import datetime

st.set_page_config(page_title="Sales Orders - Vaultly", page_icon="🛒", layout="wide")
...
with tab2:
    ...
    with st.form("create_sales_order"):
        ...
        submit = st.form_submit_button("Create Sales Order", use_container_width=True)
